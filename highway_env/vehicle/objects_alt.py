...
class Child(RoadObject):
    def __init__(self, road, position: Sequence[float], heading: float = 0, speed: float = 4):
        super().__init__(road, position, heading, speed)
...
class Adult(RoadObject):
    def __init__(self, road, position: Sequence[float], heading: float = 0, speed: float = 2):
        super().__init__(road, position, heading, speed)
        self.heading = np.random.rand() * np.pi * 2
        self.LENGTH = 1.5
        self.WIDTH = 1.5
